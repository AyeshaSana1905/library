...
<div class="container">
    <h1 style="text-align: center;">Request for Borrow</h1>
	<!-- ___________________Search bar______________-->
	 <div class="srch">
	  ...
	  <!--________________Add to cart____________-->
	  <div class="srch">
		  <form class="navbar-form" method="post" name="form1">
		    <input class="form-control" type="text" name="Id" placeholder="Enter Product ID" required="">
	...
	<?php
		...
		if(isset($_POST['submit1']))
		{
			...
			else
			{
				?>
				<script type="text/javascript">
					alert("You must login firts to add any product to cart!");
				</script>
				<?php
