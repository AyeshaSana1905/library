        ...
        <div style="color: white; margin-left: 60px; font-size: 20px;">
                ...
                <?php
                 if(isset($_SESSION['login_user']))
                 {
                    ...
                    echo "Welcome Here".$_SESSION['login_user']; 
                }
                ?>
            </div><br><br>

 
  <div class="h"> <a href="Catalog.php">Catalog</a></div>
...
<div id="main">
  ...
  <div class="container">
    ...
    <form class="Approve" action="" method="post">
        <input class="form-control" type="text" name="approval" placeholder="Yes or No" required=""><br>
...
<?php
  ...
  {
    mysqli_query($db,"UPDATE  `issue_book` SET  `approval` =  '$_POST[approval]', `issue` =  '$_POST[issue]', `return` =  '$_POST[return]' WHERE username='$_SESSION[name]' and Id='$_SESSION[Id]';");
