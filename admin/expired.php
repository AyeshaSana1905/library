...
<div class="container">
<h1 style="text-align: center;">Expired and Returned </br> Status Record</h1>
  <?php
  if(isset($_SESSION['login_user']))
  {
    ?>
  ...
  ?>
    ...
    if(isset($_SESSION['login_user']))
    {
      ...
      $sql="SELECT student.username,email,contact,books.Id,Name,Authors,Edition, issue, issue_book.return,approval FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.Id=books.Id WHERE issue_book.approval != 'Yes' and issue_book.approval != '' ORDER BY `issue_book`.`return` ASC";
